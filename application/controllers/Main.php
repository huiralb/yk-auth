...
//        $this->load_view_frontend('frontend/home'); 
    ...
    function blud(){
        $this->load->model('blud_fo_model');

        $data['periode'] = $this->blud_fo_model->getPeriode();
        //print_r($data);
    ...
    function periode_desa($id){
        $this->load->model('blud_fo_model');
        $data['periode'] = $this->blud_fo_model->getPeriodeById($id);
        $data['periode_desa'] = $this->blud_fo_model->getPeriodeDesa($id);
        //print_r($data);
    ...
    function dashboard($id){
        $this->load->model('blud_fo_model');
        $data['jmlPendaftar'] = $this->blud_fo_model->getJmlPendaftar($id);
        $data['jmlLolosVerif'] = $this->blud_fo_model->getJmlLolosVerif($id);
        $data['jmlCalon'] = $this->blud_fo_model->getCalon($id);
        $data['dpt'] = $this->blud_fo_model->getJmlDpt($id);
        $data['hasilSuara'] = $this->blud_fo_model->getHasilSuara($id);
        $data['desa'] = $this->blud_fo_model->getDesaById($id);
