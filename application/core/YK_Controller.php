...
//        }
    ...
    function load_view($template, $data = array()) {
        if (isset($_SESSION['ajax'])) {
            ...
            $menu['menu'] = $this->system_model->getMenu($_SESSION['blud']['userid']);
            $menu['authentication'] = $this->menu_model->getAuth($this->uri->segment(1)."/".$this->uri->segment(2), $_SESSION['blud']['userid']);            
    ...
    function authentication() {
        ...
        $uid = empty($_SESSION['blud']['userid']) ? 0 : $_SESSION['blud']['userid'];
